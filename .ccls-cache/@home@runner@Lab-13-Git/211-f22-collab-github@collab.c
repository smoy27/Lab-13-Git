...
void smoy27(){
  printf("Steven Moy\n");
  printf("I learned that GitHub is great for collaboration between multiple people and also that it stores our own history of changes for easier access later.");
}
